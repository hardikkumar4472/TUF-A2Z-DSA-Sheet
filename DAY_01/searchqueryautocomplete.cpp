...
public:
    AutoCompleteSystem(vector<string>& sentences, vector<int>& times) {
        ...
        for (int i = 0; i < sentences.size(); ++i) {https://media.geeksforgeeks.org/img-practice/chatIcon-1653561581.svg
...
https://media.geeksforgeeks.org/comments/562cbad0-96fc-47eb-8dd0-d0219e10e7dc_1678203048.png
        currentQuery += c;
